...
if __name__  == "__main__":
    ...
    # validation_set = frame.episode_paths("logs/CatastrophePong")
    ...
    if args.logdir == "":
        ...
        logdir = args.logdir
    hparams_list = [
        dict(batch_size=512, positive_weight_target=0.5, expected_positive_weight=0.05),
        dict(batch_size=512, positive_weight_target=0.9, expected_positive_weight=0.05),
        dict(batch_size=512, positive_weight_target=0.5, label_smoothing=True, expected_positive_weight=0.05),
        dict(batch_size=512, positive_weight_target=0.1, expected_positive_weight=0.05),
        dict(batch_size=512),
    ...
    run_experiments(logdir, data_loader, datasets, common_hparams, hparams_list, steps=1000, log_every=100)
